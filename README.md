...
For a user site repository named `enghung.github.io`, the expected production URL is:

```text
https://enghung.github.io
```
...
- The repository is named `enghung.github.io` for a user site.
